...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/efs v1.41.3
	github.com/aws/aws-sdk-go-v2/service/eks v1.74.8
	github.com/aws/aws-sdk-go-v2/service/elasticache v1.51.2
