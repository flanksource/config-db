...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RunNowRequest) DeepCopyInto(out *RunNowRequest) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RunNowRequest.
func (in *RunNowRequest) DeepCopy() *RunNowRequest {
	if in == nil {
		return nil
	}
	out := new(RunNowRequest)
	in.DeepCopyInto(out)
	return out
}
