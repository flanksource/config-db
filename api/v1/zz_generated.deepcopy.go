...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScraperExclusion) DeepCopyInto(out *ScraperExclusion) {
	*out = *in
	...
	if in.ExternalGroups != nil {
		in, out := &in.ExternalGroups, &out.ExternalGroups
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScraperExclusion.
func (in *ScraperExclusion) DeepCopy() *ScraperExclusion {
	if in == nil {
		return nil
	}
	out := new(ScraperExclusion)
	in.DeepCopyInto(out)
	return out
}
