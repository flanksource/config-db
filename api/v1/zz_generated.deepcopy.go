...
func (in *ChangeExtractionRule) DeepCopyInto(out *ChangeExtractionRule) {
	*out = *in
	...
	if in.Config != nil {
		...
		*out = make([]EnvVarResourceSelector, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExtractionVar) DeepCopyInto(out *ExtractionVar) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExtractionVar.
func (in *ExtractionVar) DeepCopy() *ExtractionVar {
	if in == nil {
		return nil
	}
	out := new(ExtractionVar)
	in.DeepCopyInto(out)
	return out
}
