...
var _ = Describe("Kubernetes RBAC config access e2e test", Ordered, func() {
	...
	It("should have saved config access entries linking subjects to the config item via the role", func() {
		...
		// All config access entries should have the role resolved
		...
		// ServiceAccount access should have user resolved
		...
		// User access should have user resolved
		...
		// Group access should have group resolved
